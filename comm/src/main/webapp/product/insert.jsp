...
<%
	/*
		...
		String[]	getParameterValues(String name)
						지정된 요청파라미터이름으로 조회된 모든 값을 배열에 순서대로 담아서 반환한다.
	*/
	...
	// eventNoArr -> {"7001", "7002", "7005"}
	String[] eventNoArr = request.getParameterValues("eventNo");
	
	// Product 클래스의 정적 메소드 createProduct(값, 값, ... 값)을
	...
	for (String value : eventNoArr) {
		...
		// ProductEvetn는 상품정보(no=상품번호, cat=카테고리, company=제조사, ...)
		//				  이벤트정보(no=번호, title=null, description=null)
