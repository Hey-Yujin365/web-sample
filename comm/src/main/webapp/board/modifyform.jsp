...
<%
	...
	*/
	...
	// 2. COMM_BOARDS에 대한 CRUD기능을 제공하는 BoardDao객체 생성
	BoardDao boardDao = new BoardDao();
	
	// 3. BoardDao객체의 getBoardByNo(int no)를 실행해서 게시글 상세정보 조회
...
%>
			...
			<form class="border bg-light p-3"
				...
				<div class="form-group mb-3">
					...
					<input type="text" class="form-control" value="<%=board.getUser().getName() %>" readonly="readonly">
				</div>
				<div class="form-group mb-3">
