...
<%
	...
	*/
	...
	param.put("rows", rows);	// 출력개수를 Map에 저장한다.
...
<script type="text/javascript">
	function changeRows() {
		...
		// 검색폼의 히든필드(name=rows)를 변경된 출력개수로 설정한다.
	...
	function changeSort() {
		...
		// 검색폼의 히든필드(name=sort)를 변경된 정렬방식으로 설정한다.
