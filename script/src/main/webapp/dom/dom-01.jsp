...
<!-- 
	domument.getElementById(id)
		+ 지정된 id속성값으로 엘리먼트를 한 개 선택하고, 반환한다.
		+ 일치하는 엘리먼트가 없으면 null을 반환한다.
		+ 지정된 id속성값과 일치하는 엘리먼트가 여러 개 있으면, 첫 번째 엘리먼트를 반환한다.
 -->
		
			<div>
				<p id="el-1">첫 번째 p엘리먼트</p>
				<p id="el-2">두 번째 p엘리먼트</p>
				<p id="el-3">세 번째 p엘리먼트</p>
				<p id="el-4">네 번째 p엘리먼트</p>
				<p id="el-5">다섯 번째 p엘리먼트</p>
			</div>
		</div>
	</div>
</div>
