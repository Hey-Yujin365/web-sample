...
<script type="text/javascript">
	/*
		...
		* DOMTokenList 객체는 문자열을 여러 개 저장하고 있는 객체다.
		* DONTokenList 객체의 주요 메소드
			add("텍스트")
				지정된 텍스트를 DOMTokenList 객체에 추가한다.
			remove("텍스트")
				지정된 텍스트를 DOMTokenList 객체에서 삭제한다.
			toggle("텍스트")
				지정된 텍스트를 DOMTokenList 객체에서 토글시킨다.
				존재하면 삭제하고, 없으면 추가한다.
			contains("텍스트")
				DOMTokenList 객체에 지정된 텍스트가 존재하면 true,
