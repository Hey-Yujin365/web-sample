...
<script type="text/javascript">
	...
	function appendUsingInnerHTML() {
		...
		// 2. 새로 추가할 HTML 콘텐츠를 생성한다.
		let html = `
			<input tyep="text" name="username" value="김유신" />
		`;
	...
	function deleteAll() {
		...
		// 2. 선택한 tbody엘리먼트의 html 콘텐츠를 전부 삭제하기
		tbody.innerHTML = "";
	}
	...
	function deleteSelectedTr() {
		...
		// 2. 체크상태인 체크박스의 개수를 조회해서 개수가 0개면 경고창을 표시하고, 종료한다.
	...
	function changeCheckbox() {
		...
		// 4. 전체 체크박스의 개수와 체크된 체크박스의 개수를 비교해서
